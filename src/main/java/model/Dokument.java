...
public class Dokument implements IDepictable, IPersistable {
    ...
    public Dokument(String title, String filePath) {
        this(null, title, filePath, null);
    }

    public Dokument(String iD, String title, String filePath, String key) {
        super();
...
//    public ImageIcon getImage() { return (ImageIcon) this.attArr[ Attributes.IMAGE.ordinal()].getValue(); }
    ...
    public String getElementID() {
        return this.attArr[ Dokument.Attributes.ID.ordinal() ].getValue().toString();
    }
    ...
    public Object getPrimaryKey() {
        return this.attArr[ Dokument.Attributes.ID.ordinal() ].getValue();
    }
}
